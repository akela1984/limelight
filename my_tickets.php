          ...
          // Check session
            if (isset($_SESSION['ADULT']) || isset($_SESSION['ADMIN']) || isset($_SESSION['JUNIOR']))
            {
              // Create connection with MySQL Database
                ...
                $sql = "SELECT * FROM limelightcinema_orders WHERE user_ID='$userID' ORDER BY order_date DESC";
                ...
                if ($count < 1)
                {
                    ...
                    <h6>You have no Ticket(s) booked!</h6>
                    </div>";
                }
                else
                {
                    ...
                    <div class='content_header d-flex justify-content-center'>
                      <h4>Ticket(s) you've previously booked</h4>
                    </div><br>
                    ";
                                         ...
                                         <div class='whatson-movie-box-body'>
                                          <div class='card-body flex-column'>
                                           <form action='print_ticket.php' method='POST'>
                                            ...
                                            <input class='btn' type='submit' name='print_ticket' value='Print eTicket'>
                                            </form>
                                           <hr>
                                     </div>
                                   </div>
